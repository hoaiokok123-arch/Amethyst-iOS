...
@interface LauncherProfileEditorViewControllerBase()<UIPickerViewDataSource, UIPickerViewDelegate>
...
@implementation LauncherProfileEditorViewControllerBase
...
- (void)viewDidLoad {
    ...
    __weak LauncherProfileEditorViewControllerBase *weakSelf = self;
