...
+ (id)defaultPrefForGlobal:(BOOL)global {
    ...
    NSMutableDictionary<NSString *, NSMutableDictionary *> *defaults = @{
        ...
        @"control": @{
            ...
            @"recording_hide": @YES,
            @"gesture_mouse": @YES,
            @"gesture_mouse_tap_hold": @YES,
            @"gesture_mouse_scroll": @YES,
            @"gesture_hotbar": @YES,
            @"disable_haptics": @NO,
            @"slideable_hotbar": @NO,
            @"press_duration": @(400),
    ...
    if (global) {
        ...
        NSDictionary *general = @{
            ...
            @"theme_accent": @"teal",
            @"theme_mode": @"system",
            @"theme_text_color": @"default",
            @"theme_text_opacity": @(100),
            @"theme_button_opacity": @(100),
            @"theme_button_outline": @NO,
            @"theme_button_corner_radius": @(12),
            @"theme_button_border_width": @(1),
            @"theme_background_image": @"",
            @"theme_background_image_landscape": @"",
            @"theme_background_video": @"",
            @"theme_background_video_landscape": @"",
            @"theme_background_opacity": @(100),
            @"theme_background_blur": @(0),
            @"theme_background_dim": @(0),
            ...
            @"menu_show_news": @YES,
            @"menu_show_profiles": @YES,
            @"menu_show_settings": @YES,
